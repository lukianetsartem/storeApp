            ...
            <div className={'style-page-header'}>
                <div className={'style-page-header-promo'}>
                    <div className={'style-page-header-promo-content'}>
                        <div>
                            <img src={'https://res-1.cloudinary.com/made-com/image/upload/a_auto,b_transparent,c_pad,d_made.svg,dpr_1.0,f_auto,q_auto:best,w_1440/v4/wysiwyg/find-your-style/fys-icon01.jpg'}/>
                            <p>LIKE 7 PICTURES</p>
                            <span>Show us what you like using our style gallery.</span>
                        </div>
                        <div>
                            <img src={'https://res-1.cloudinary.com/made-com/image/upload/a_auto,b_transparent,c_pad,d_made.svg,dpr_1.0,f_auto,q_auto:best,w_1440/v4/wysiwyg/find-your-style/fys-icon02.jpg'}/>
                            <p>YOUR STYLE</p>
                            <span>Find out more about your 2 dominant styles.</span>
                        </div>
                        <div>
                            <img src={'https://res-1.cloudinary.com/made-com/image/upload/a_auto,b_transparent,c_pad,d_made.svg,dpr_1.0,f_auto,q_auto:best,w_1440/v4/wysiwyg/find-your-style/fys-icon03.jpg'}/>
                            <p>YOUR PRODUCTS</p>
