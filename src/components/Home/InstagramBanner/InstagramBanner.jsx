...
export const InstagramBanner = () => {
    return(
        <div className={'instagram-banner'}>
            <img alt={''} src={'https://photorankmedia-a.akamaihd.net/media/d/y/t/dyt6sq4/normal.jpg'}/>
            <div className={'instagram-banner-content'}>
                ...
                <a target="_blank" rel="noopener noreferrer" href={'https://instagram.com/'}>View Gallery</a>
                <div className={'instagram-banner-icon'}>
                    <InstagramIcon/>
                </div>
            </div>
            <img alt={''} src={'https://z2photorankmedia-a.akamaihd.net/media/o/s/8/os83vs4/normal.jpg'} />
        </div>
    )
}