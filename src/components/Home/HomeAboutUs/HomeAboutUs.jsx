    ...
    return (
        <div className={'home-about-us'}>
            <div className={'home-about-us-content'}>
                <img src={'https://img.made.com/image/upload/c_lfill,d_madeplusgrey.svg,f_auto,g_auto,h_720,q_auto:best,w_720/v1/mws-critical/b1a276d9-a517-4fd4-9699-22ce039901d9_TL6_HP_POD_1000%2Bx%2B994px.jpg'} />
                <div className={'home-about-us-content'}>
